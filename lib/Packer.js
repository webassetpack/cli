    ...
    pack(definition) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            for (let name in definition) {
                let path = Path.resolve(definition[name].path);
                let stat = FileSystem.lstatSync(path);
                let type = definition[name].type;
                if (!type) {
            ...
            return new Promise((resolve, reject) => {
                ...
                headerBuffer.writeUInt16BE(version.major, core_1.BYTE_POS_VERSION_MAJOR);
                headerBuffer.writeUInt16BE(version.minor, core_1.BYTE_POS_VERSION_MINOR);
                headerBuffer.writeUInt16BE(version.patch, core_1.BYTE_POS_VERSION_PATCH);
                headerBuffer.writeUInt16BE(manifestLength, core_1.BYTE_POS_MANIFEST_LENGTH);
