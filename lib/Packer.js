...
class Packer {
    ...
    pack(definition) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                ...
                let output = FileSystem.createWriteStream(this._destination);
    ...
    _verify() {
        return new Promise((resolve, reject) => {
            ...
            let readStream = FileSystem.createReadStream(this._destination);
            let needsToIgnoreHeader = true;
            readStream.on('data', (chunk) => {
                let data = null;
                let manifestLength = null;
                if (needsToIgnoreHeader) {
                    if (manifestLength === null) {
                        manifestLength = chunk.readUInt16LE(core_1.BYTE_POS_MANIFEST_LENGTH) + core_1.BYTE_HEADER_SIZE;
                    }
